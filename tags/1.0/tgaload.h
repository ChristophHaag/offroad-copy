...
const short TGA_DEFAULT =           0x0000;   /* In case we don't want any parameters */
const short TGA_FREE  =             0x0001;   /* Bit flag 0 */
const short TGA_NO_PASS  =          0x0002;   /* Bit flag 1 */
const short TGA_ALPHA     =         0x0004;   /* Bit flag 2 */
const short TGA_LUMINANCE  =        0x0008;   /* Bit flag 3 */
const short TGA_NO_MIPMAPS   =      0x0010;   /* Bit flag 4 */
const short TGA_LOW_QUALITY  =      0x0020;   /* Bit flag 5 */
const short TGA_COMPRESS     =      0x0040;   /* Bit flag 6 */
...
void   tgaLoad        ( char *file_name, image_t *p, tgaFLAG mode, GLuint type );
